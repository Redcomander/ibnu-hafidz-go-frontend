<template>
  ...
  >
    ...
    <!-- Halaqoh / Circle of People -->
    <template v-else-if="name === 'halaqoh'">
    ...
    <template v-else-if="name === 'laundry'">
      <path
        d="M20.38 3.46L16 2 13.5 4.5a3.12 3.12 0 0 1-3 0L8 2 3.62 3.46a2 2 0 0 0-1.34 2.23l.58 3.47a1 1 0 0 0 .99.84H6v10c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V10h2.15a1 1 0 0 0 .99-.84l.58-3.47a2 2 0 0 0-1.34-2.23z"
      />
    </template>
    ...
    <!-- Document Add -->
    <template v-else-if="name === 'document-add'">
      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
      <polyline points="14 2 14 8 20 8" />
    ...
    <!-- Document Download -->
    <template v-else-if="name === 'document-download'">
      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
      <polyline points="14 2 14 8 20 8" />
    ...
    <template v-else-if="name === 'quote'">
      <path d="M3 21c3 0 7-1 7-8V5c0-1.25-4.4 0-4.5.5.5-1 2.6-4 7-4s4 3-1 4c-1 0-2 .25-3 1 1-1 2-1 3-1s3.5 1 3.5 4c-.5 3-2 5-4 6V21c-1.5 0-3 0-5-.5z" />
      <path d="M15 21c3 0 7-1 7-8V5c0-1.25-4.4 0-4.5.5.5-1 2.6-4 7-4s4 3-1 4c-1 0-2 .25-3 1 1-1 2-1 3-1s3.5 1 3.5 4c-.5 3-2 5-4 6V21c-1.5 0-3 0-5-.5z" />
    </template>
